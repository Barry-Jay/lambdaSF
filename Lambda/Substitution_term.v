...
Lemma subst_eq :
 forall (M U : lambda) (n : nat), subst_rec (Ref n) U n = lift n U. 
Proof.
...
Lemma subst_lt :
 forall (M U : lambda) (n p : nat), p > n -> subst_rec (Ref n) U p = Ref n.
Proof.
simpl in |- *; unfold insert_Ref in |- *.
...
forall (W V : lambda)(n : nat), subst_rec (lift_rec W n 1) V n = W.
Proof.
